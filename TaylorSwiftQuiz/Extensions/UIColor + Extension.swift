...
extension UIColor {
    ...
    static let reputation = UIColor(red: 30/255, green: 30/255, blue: 30/255, alpha: 1.0)
    static let lover = UIColor(red: 255/255, green: 168/255, blue: 204/255, alpha: 1.0)
    static let folklore = UIColor(red: 149/255, green: 149/255, blue: 149/255, alpha: 1.0)
    static let evermore = UIColor(red: 129/255, green: 96/255, blue: 62/255, alpha: 1.0)
    static let midnights = UIColor(red: 56/255, green: 84/255, blue: 123/255, alpha: 1.0)
}
